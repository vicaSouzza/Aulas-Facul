...
FOREIGN KEY (cod_imovelFK_clientes) REFERENCES  Clientes(cod_cliente),
cod_corretor_vendas INT NOT NULL,
FOREIGN KEY (cod_imovelFK_clientes) REFERENCES  Corretor(cod_corretor)
);
...
cod_vendaFK_corretor INT NOT NULL,
FOREIGN KEY (cod_imovelFK_clientes) REFERENCES Vendas(cod_venda)
);
